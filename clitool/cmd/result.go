...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = resultJob(jobconfig, serverIP, serverPort)
...
func resultJob(jobconfig jobConfig, server string, port string) error {
	url := "http://" + server + ":" + port + "/jobresult/" + jobconfig.Job_name
